...
function cwcp_registration_shortcode() {
    ...
    if (is_user_logged_in()) {
        ...
        return '<div class="cwcp-page cwcp-scope cwcp-auth-page"><div class="cwcp-container">'
    ...
    ob_start();
    ?>
    <div class="cwcp-page cwcp-scope cwcp-auth-page">
...
function cwcp_login_shortcode() {
    ...
    if (is_user_logged_in()) {
        ...
        return '<div class="cwcp-page cwcp-scope cwcp-auth-page"><div class="cwcp-container cwcp-container-narrow">'
            . '<div class="cwcp-card cwcp-pad">'
...
function cwcp_reset_password_shortcode() {
    ...
    echo '<div class="cwcp-page cwcp-scope cwcp-auth-page"><div class="cwcp-container cwcp-container-narrow">';
...
function cwcp_require_login_notice() {
    ...
    return '<div class="cwcp-page cwcp-scope"><div class="cwcp-container cwcp-container-narrow">'
